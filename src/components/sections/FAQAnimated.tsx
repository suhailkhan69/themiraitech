  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-between px-6 py-5 text-left hover:bg-[#18181B] transition-colors duration-150"
        aria-expanded={open}
      >
        <span className="font-heading text-sm font-semibold text-[#F5F5F7] pr-4">{question}</span>
        <motion.div
        ...
        {open && (
          ...
          >
            <div className="px-6 pb-5">
              <p className="text-[#A1A1AA] text-sm leading-relaxed">{answer}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
