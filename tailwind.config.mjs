      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            h1: { color: '#F0F6FC', fontFamily: 'Bricolage Grotesque Variable, Bricolage Grotesque, sans-serif' },
            h2: { color: '#F0F6FC', fontFamily: 'Bricolage Grotesque Variable, Bricolage Grotesque, sans-serif' },
            h3: { color: '#F0F6FC', fontFamily: 'Bricolage Grotesque Variable, Bricolage Grotesque, sans-serif' },
            h4: { color: '#F0F6FC', fontFamily: 'Bricolage Grotesque Variable, Bricolage Grotesque, sans-serif' },
            strong: { color: '#F0F6FC' },
